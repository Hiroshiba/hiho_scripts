---
name: write-script
description: bash・Python スクリプトの作成・修正。「スクリプトを書いて」「bash スクリプト」「Python スクリプト」「スクリプトを作成」「スクリプトを修正」と言われたときに使用。
---

## 手順

1. 以下の既存ファイルを読んでパターンを把握する:
...
拡張子: `.py` / shebang: `#!/usr/bin/env python3`
